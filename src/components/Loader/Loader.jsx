...
const Loader = ({ airlineName = 'AirSial' }) => {
  return (
    <div
    ...
    >
      <div className="relative w-[230px] h-[230px]">
        {/* Spinning SVG part */}
        <svg className={styles.svgCalLoader} xmlns="http://www.w3.org/2000/svg" width={230} height={230}>
          <path
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          {/* <span className={styles.airlineText}>{airlineName}</span> */}
          <img src={AirSialLogo} className="w-30" />
        </div>
      </div>
    </div>
  );
