...
const Breadcrumb = ({ navigation = [] }) => {
  return (
    <nav
      className="my-5 flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700"
                ...
                {isLink ? (
                  ...
                  <span
                    className={`ms-1 text-sm font-medium ${
                      isLast ? 'text-primary' : 'text-gray-500 dark:text-gray-400'
                    } cursor-default md:ms-2`}
                  >
                    {nav.label}
                  </span>
                )}
