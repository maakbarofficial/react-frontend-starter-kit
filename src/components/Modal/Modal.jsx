...
const Modal = ({
  ...
  useEffect(() => {
    if (!isOpen || !closeIfClickOutside) return;
  ...
  }, [isOpen, closeIfClickOutside, onClose]);
    ...
    >
      <div className="relative p-4 w-full max-w-2xl max-h-full" ref={modalRef}>
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          {/* Modal header */}
          <div className="flex items-center justify-between p-4 border-gray-200 border-b rounded-t dark:border-gray-600">
