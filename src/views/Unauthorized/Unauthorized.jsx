...
const Unauthorized = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-full gap-12 py-8 ">
      ...
      <div className="flex flex-col items-center gap-4">
        <h1 className="text-3xl font-bold text-center capitalize text-primary">You are not authorized</h1>
